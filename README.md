...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/openfermionpyscf-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15488&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/openfermionpyscf-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `openfermionpyscf` can be installed with:

```
conda install openfermionpyscf
```

It is possible to list all of the versions of `openfermionpyscf` available on your platform with:
